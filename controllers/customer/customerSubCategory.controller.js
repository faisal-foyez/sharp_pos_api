...
const {services } = require('../../services/customer/customerSubCategory.service');
...
//GET ALL CUSTOMER_SUB_CATEGORIES
...
//GET SINGLE CUSTOMER_SUB_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET CUSTOMER_SUB_CATEGORIES BY PAGE
...
//ADD SINGLE CUSTOMER_SUB_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE CUSTOMER_SUB_CATEGORY
...
//DELETE SINGLE CUSTOMER_SUB_CATEGORY
