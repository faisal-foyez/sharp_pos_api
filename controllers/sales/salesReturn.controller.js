...
const { services } = require('../../services/sales/salesReturn.service');
...
//GET SINGLE SALES_RETURN BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);
})

// GET SALES_RETURNS BY PAGE
...
//ADD SINGLE SALES_RETURN
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);
})

//UPDATE SINGLE SALES_RETURN
router.put('/:id',upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);
})

//DELETE SINGLE SALES_RETURN
