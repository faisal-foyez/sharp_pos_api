...
const { services } = require('../../services/sales/salesReturnDetails.service');
...
//GET SINGLE SALES_RETURN_DETAIL BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);
})

// GET SALES_RETURN_DETAILS BY PAGE
...
//ADD SINGLE SALES_RETURN_DETAIL
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);
})

//UPDATE SINGLE SALES_RETURN_DETAIL
router.put('/:id',upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);
})

//DELETE SINGLE SALES_RETURN_DETAIL
