...
const { services } = require('../../services/supplier/supplierCategory.service');
...
//GET SINGLE SUPPLIER_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET SUPPLIER_CATEGORIES BY PAGE
...
//ADD SINGLE SUPPLIER_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE SUPPLIER_CATEGORY
router.put('/:id', upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE SUPPLIER_CATEGORY
