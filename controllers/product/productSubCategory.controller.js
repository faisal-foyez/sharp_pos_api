...
const {services } = require('../../services/product/productSubCategory.service');
...
//GET SINGLE PRODUCT_SUB_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET PRODUCT_SUB_CATEGORIES BY PAGE
...
//ADD SINGLE PRODUCT_SUB_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE PRODUCT_SUB_CATEGORY
router.put('/:id', upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE PRODUCT_SUB_CATEGORY
