...
const { services } = require('../../services/product/vatCategory.service');
...
//GET SINGLE VAT_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);
})

// GET VAT_CATEGORIES BY PAGE
...
//ADD SINGLE VAT_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);
})

//UPDATE SINGLE VAT_CATEGORY
router.put('/:id', upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);
})

//DELETE SINGLE VAT_CATEGORY
