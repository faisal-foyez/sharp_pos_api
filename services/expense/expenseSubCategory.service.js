const ExpenseSubCategory = require('../../models/expense/ExpenseSubCategory.model');
const RootService = require('../Root.service');

exports.services = RootService(ExpenseSubCategory);
// const RootService = require('../Root.service');

// const Entity = ExpenseSubCategory;
// //GET ALL ENTITIES
