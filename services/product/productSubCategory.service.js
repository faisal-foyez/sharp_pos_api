const ProductSubCategory = require('../../models/product/ProductSubCategory.model');
const RootService = require('../Root.service');

exports.services = RootService(ProductSubCategory);
// const RootService = require('../Root.service');

// const Entity = ProductSubCategory;
// //GET ALL ENTITIES
