const SupplierSubCategory = require('../../models/supplier/SupplierSubCategory.model');
const RootService = require('../Root.service');

exports.services = RootService(SupplierSubCategory);
// const RootService = require('../Root.service');

// const Entity = SupplierSubCategory;
// //GET ALL ENTITIES
