...
const { services} = require('../../services/customer/customerCategory.service');
...
//GET SINGLE CUSTOMER_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET CUSTOMER_CATEGORIES BY PAGE
...
//ADD SINGLE CUSTOMER_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE CUSTOMER_CATEGORY
router.put('/:id',upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE CUSTOMER_CATEGORY
