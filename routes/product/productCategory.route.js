...
const { services } = require('../../services/product/productCategory.service');
...
//GET SINGLE PRODUCT_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET PRODUCT_CATEGORIES BY PAGE
