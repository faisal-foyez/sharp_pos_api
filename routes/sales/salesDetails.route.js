...
const { services } = require('../../services/sales/salesDetails.service');
...
//GET SINGLE SALES_DETAIL BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET SALES_DETAILS BY PAGE
