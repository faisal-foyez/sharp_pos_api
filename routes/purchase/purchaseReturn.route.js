...
const { services } = require('../../services/purchase/purchaseReturn.service');
...
//GET SINGLE PURCHASE_RETURN BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET PURCHASE_RETURNS BY PAGE
...
//ADD SINGLE PURCHASE_RETURN
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE PURCHASE_RETURN
router.put('/:id', upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE PURCHASE_RETURN
