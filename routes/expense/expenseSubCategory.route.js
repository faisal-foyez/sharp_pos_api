...
const { services } = require('../../services/expense/expenseSubCategory.service');
...
//GET ALL EXPENSE_SUB_CATEGORIES
...
//GET SINGLE EXPENSE_SUB_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET EXPENSE_SUB_CATEGORIES BY PAGE
...
//ADD SINGLE EXPENSE_SUB_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE EXPENSE_SUB_CATEGORY
router.put('/:id',upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE EXPENSE_SUB_CATEGORY
