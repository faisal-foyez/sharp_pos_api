...
const { services } = require('../../services/expense/expenseCategory.service');
...
//GET SINGLE EXPENSE_CATEGORY BY ID
router.get('/:id', async (req, res) => {
    RouteServices.getOne(req, res);

})

// GET EXPENSE_CATEGORIES BY PAGE
...
//ADD SINGLE EXPENSE_CATEGORY
router.post('/', upload.any(), async (req, res) => {
    RouteServices.addOne(req, res);

})

//UPDATE SINGLE EXPENSE_CATEGORY
router.put('/:id',upload.any(), async (req, res) => {
    RouteServices.updateOne(req, res);

})

//DELETE SINGLE EXPENSE_CATEGORY
